...
urlpatterns = [
    ...
    path('kulynshak', views.kulynshak, name='kulynshak'),
    path('balapan', views.balapan, name='balapan'),
    path('baldauren', views.baldauren, name='baldauren'),
    path('balbobek', views.balbobek, name='balbobek'),
    path('bolashak', views.bolashak, name='bolashak'),
    path('baldyrgan', views.baldyrgan, name='baldyrgan'),
